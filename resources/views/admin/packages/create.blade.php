                        ...
                        <div class="mt-2 flex flex-wrap sm:flex-nowrap gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        <div class="dropdown w-full" id="dropdown">
                                            ...
                                            <div class="dropdown-content  border border-grey overflow-scroll"
                                                id="dropdown-content">
                                                @foreach ($tests as $test)
                                                    
                                                    <label>
                                                        <input type="checkbox" value="{{ $test->id }}"
                                                            onchange="updateTotalCount(this)" name="selected_tests[]"
                            ...
                            <div class="w-full">
                                <div class="mt-2 {{ $errors->has('total_test_included') ? 'border-red-500' : '' }}">
                                    ...
                                    <input type="text" name="total_test_included" id="total_test_included"
                        ...
                        <div class="mt-2 flex flex-wrap sm:flex-nowrap  gap-6">
                            <div class="w-full">
                                <div class="mt-2 {{ $errors->has('description_en') ? 'border-red-500' : '' }}">
                                    ...
                                    <textarea name="description_en" id="description_en" cols="20" rows="2" class="mt-2 w-full p-2 rounded-md focus:ring-0 text-sm resize-none" placeholder="Description in English">{{ old('description_en') }}</textarea>
                                </div>
                            </div>
                            <div class="w-full">
                                <div class="mt-2 {{ $errors->has('description_hi') ? 'border-red-500' : '' }}">
                                    ...
                                    <textarea name="description_hi" id="description_hi" cols="20" rows="2" class="mt-2 w-full p-2 rounded-md focus:ring-0 text-sm resize-none " placeholder="Description in Hindi">{{ old('description_hi') }}</textarea>
                                </div>
                            </div>
                            <div class="w-full">
                                <div class="mt-2 {{ $errors->has('description_mr') ? 'border-red-500' : '' }}">
                                    ...
                                    <textarea name="description_mr" id="description_mr" cols="20" rows="2" class="mt-2 w-full p-2 rounded-md focus:ring-0 text-sm resize-none  @if($errors->has('description_mr')) border-red-500 @endif" placeholder="Description in Marathi">{{ old('description_mr') }}</textarea>
                                </div>
                            </div>
