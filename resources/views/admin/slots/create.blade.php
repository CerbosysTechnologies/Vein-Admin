    ...
    <div class="relative overflow-hidden md:text-md text-lg">
      <div class="bg-white p-4 mt-2">
        <div class="flex items-center w-full">
          <h1 class="font-medium text-xl m-0 text-primary whitespace-nowrap mr-2">Add Slot</h1>
            ...
            <div class="w-full">
              <form action="{{ route('admin.slot.store') }}" method="POST">
                ...
                <div>
                    ...
                    <select name="appointment_type" id="appointment_type" class="mt-2 w-full h-8 px-2 rounded-md focus:ring-0 text-sm" onchange="toggleTimeSlots(this.value)">
