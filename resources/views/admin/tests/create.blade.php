        ...
        <div class="relative overflow-hidden md:text-md text-lg">
            <div class="bg-white p-4 mt-2">
                <div class="flex items-center w-full">
                    <h1 class="font-medium text-xl m-0 text-primary whitespace-nowrap mr-2">Add Test</h1>
                ...
                <form action="{{ route('admin.test.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="shadow-md mt-4 p-2 pb-10">
                          ...
                          <div class="m-5 flex flex-wrap sm:flex-nowrap gap-4">
                            <div class="w-full">
                                <div class="mt-2 {{ $errors->has('description_en') ? 'border-red-500' : '' }}">
                                    ...
                                    <textarea name="description_en" id="description_en" cols="20" rows="2" class="mt-2 w-full p-2 rounded-md focus:ring-0 text-sm resize-none  @if($errors->has('description_en')) border-red-500 @endif" placeholder="Description in English" placeholder="Description in English"></textarea>
                                </div>
                            </div>
                            <div class="w-full">
                                <div class="mt-2 {{ $errors->has('description_hi') ? 'border-red-500' : '' }}">
                                    ...
                                    <textarea name="description_hi" id="description_hi" cols="20" rows="2" class="mt-2 w-full p-2 rounded-md focus:ring-0 text-sm resize-none  @if($errors->has('description_hi')) border-red-500 @endif" placeholder="Description in Hindi" placeholder="Description in Hindi" ></textarea>
                                </div>
                            </div>
                            <div class="w-full">
                                <div class="mt-2 {{ $errors->has('description_mr') ? 'border-red-500' : '' }}">
                                    ...
                                    <textarea name="description_mr" id="description_mr" cols="20" rows="2" class="mt-2 w-full p-2 rounded-md focus:ring-0 text-sm resize-none  @if($errors->has('description_mr')) border-red-500 @endif" placeholder="Description in Marathi" placeholder="Description in Marathi" ></textarea>
                                </div>
                            </div>
                        ...
                        <div class="m-5 flex flex-wrap sm:flex-nowrap  gap-10">
                            <div class="w-full">
                                <div class="mt-2 {{ $errors->has('price') ? 'border-red-500' : '' }}">
                                    <label for="price" class="text-sm font-medium">
                                        <span class="text-red">*</span> Price
                                    </label>
                                    <input type="text" name="price" id="price" class="mt-2 w-full h-8 p-2 rounded-md focus:ring-0 text-sm @if($errors->has('price')) border-red-500 @endif" placeholder="Price">
                                    @error('price')
                            ...
                            <div class="w-full">
                                <div class="mt-2 {{ $errors->has('images') ? 'border-red-500' : '' }}">
                                    <label for="test_name" class="text-sm font-medium">
                                        <span class="text-red">*</span> Attach Image
                                    </label>
                                    <div
                                        class="mt-2 max-w-[15rem] max-h-[11rem] p-2 border border-dashed border-black rounded-md  @if($errors->has('images')) border-red-500 @endif">
                                        <div class="">
                                        ...
                                        <input type="file" name="images" id="file" class="hidden" placeholder="Price" onchange="previewImage(event, 'preview-image')">
